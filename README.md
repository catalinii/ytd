...
The environment variables used for the model depends on the default model defined in indexer.py
...
- reindex_all - Indexes all videos from an youtube playlist (requires OPENAI_KEY/GEMINI_KEY and APIKEY - youtube key)
...
Note:
- reindex_all.py needs to use https_proxy from hosted servers as youtube does not allow querying information about videos
